...
public Class cliente {
  ...
  public static void main(String[] args) {
    ...
    Felipe.setNomeCli("Felipe Dias Damasceno");
    Felipe.setIdCliente(1);
    Felipe.setRgCli(45678901);
    Felipe.setEndereco("Rua av joao colado 110");
    Felipe.setBairro("Jardim Fortaleza");
    Felipe.setCidade("São Paulo");
    Felipe.setEstado("SP");
    Felipe.setCep("07153500
    
    ");
    Felipe.setDddCel(11);
    Felipe.setTelCel("93000002");

    // Exibindo a inclusão do cliente
    System.out.println("Inclui o cliente: " + Felipe.getNomeCli() + ". ");

    // Chamadas de métodos corrigidos
    Felipe.cadastraCliente();
    Felipe.efetuaPedido();
    Felipe.efetuaPagamento();
    Felipe.alteraDados();
    Felipe.consultaDados();
    Felipe.excluiCliente();
